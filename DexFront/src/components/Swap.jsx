...
function Swap(props) {
  ...
  function switchTokens(){
    // Making the current prices null
    setPrices(null)
    ...
    // switching the prices for two tokens
  ...
  function modifyToken(i){
    // Making the prices of current tokens null
    setPrices(null)
    setTokenOneAmount(null)
    setTokenTwoAmount(null)

    // changing and assigning new prices
    if (changeToken === 1){
  ...
  useEffect(() => {
    // Destroying the previous messages
    messageApi.destroy()
